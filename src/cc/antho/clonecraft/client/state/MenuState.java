...
public class MenuState extends State {
	...
	private void loadUI() {
		...
		try { 
			...
			String vertexShader = Shader.loadShaderString("/shaders/ui_vertex.glsl");
			String fragmentShader = Shader.loadShaderString("/shaders/ui_fragment.glsl");
	...
	public void tick() {
		...
		// TODO it should wait a certain amount of time before switching states (not keypress)
